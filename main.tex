...
\begin{document}
  ...
  \end{frame}
    ...
    \begin{frame}[t]{Android Software Development Kit} 
        ...
        \begin{block}{SDK Tools}
           Część wymagana do tworzenia aplikacji niezależnie od wersji Androida
      \end{block}

      \begin{block}{Platform Tools}
       Narzędzia zmodyfikowane pod kątem konkretnej wersji systemu
    \end{block}

        \begin{center}\vspace{0pt}
            \includegraphics[scale=0.2]{sdkLogo}
          \end{center}
  ...
  \end{block}
    ...
    \begin{frame}[t]{Android Virtual Device} 
        \begin{block}{Czym jest AVD?}
            Urządzenie wirtualne z systemem Android.Możemy zdefiniować czy jest to telefon, tablet, Wear OS, Android TV lub Auto OS 
            oraz jego podstawowe parametry czy cechy zachowania.
  \end{block}
        \begin{center}\vspace{0pt}
